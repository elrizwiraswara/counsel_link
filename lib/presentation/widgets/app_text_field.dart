      ...
      children: [
        labelText != null && labelText != ''
            ? Padding(
                ...
                child: Text(labelText!, style: AppTextStyle.bold(size: fontSize - 2)),
              )
        ...
        GestureDetector(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              ...
              hintText: hintText,
              hintStyle: AppTextStyle.medium(size: fontSize, color: AppColors.blackLv2),
              contentPadding: contentPadding,
              focusedBorder: showBorder
                  ? const OutlineInputBorder(
                      borderRadius: BorderRadius.all(Radius.circular(4.0)),
                      borderSide: BorderSide(width: 1, color: AppColors.blackLv3),
                    )
                  : InputBorder.none,
              enabledBorder: showBorder
                  ? const OutlineInputBorder(
                      borderRadius: BorderRadius.all(Radius.circular(4.0)),
                      borderSide: BorderSide(width: 0.5, color: AppColors.blackLv3),
                    )
                  : InputBorder.none,
